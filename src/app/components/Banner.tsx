...
export default function Banner() {
  return (
    <section className='relative grid max-w-3xl shadow-[0px_10px_20px_0px_rgba(0,_0,_0,_0.10)]'>
        <Image
          src={BannerImage}
          alt='Image Text'
          width={896}
        ...
        ></Image>
        <div className='absolute grid gap-2 bottom-0 w-auto text-white text-xs p-3 bg-black bg-opacity-40 bg-blend-screen backdrop-blur'>
